  ...
  logIn(LogInRequest request, loginScreenState _screenState) {
    ...
    _logInRepository.loginRequest(request).then((value) {
      if (value == null) {
        ...
        Fluttertoast.showToast(msg: 'Incorrect Password',backgroundColor: PrimaryColor);
        ...
        Navigator.pushNamedAndRemoveUntil(
            _screenState.context, HomePageRoutes.homePage, (route) => false);
      }
      else{
        _loadingStateSubject.add(AsyncSnapshot.nothing());
        Fluttertoast.showToast(msg: value.errorMessage,backgroundColor: PrimaryColor);
      }
    });
  }
}
